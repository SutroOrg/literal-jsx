...
import lexerFactory from './lexer.ts';
...
let ParserRules = [
    ...
    {"name": "closingTag", "symbols": [(lexer.has("startclose") ? {type: "startclose"} : startclose), "_", "elementName", "_", {"literal":">"}], "postprocess": 
    ...
    {"name": "furtherElement", "symbols": [(lexer.has("selfclose") ? {type: "selfclose"} : selfclose)], "postprocess": 
        function ([selfclose]) {
          return {
            further: {
              loc: {
    ...
    {"name": "child", "symbols": [(lexer.has("codeblock_backticks") ? {type: "codeblock_backticks"} : codeblock_backticks)], "postprocess": plaintext_literal},
    {"name": "child", "symbols": [(lexer.has("inlinecode_backtick") ? {type: "inlinecode_backtick"} : inlinecode_backtick)], "postprocess": plaintext_literal},
